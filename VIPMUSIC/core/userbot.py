...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("TELE_SONG_BOT")
                await self.two.join_chat("TELE_SONG_BOT")
                await self.two.join_chat("TELE_SONG_BOT")
                await self.two.join_chat("TELE_SONG_BOT")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("TELE_SONG_BOT")
                await self.three.join_chat("TELE_SONG_BOT")
                await self.three.join_chat("TELE_SONG_BOT")
                await self.three.join_chat("TELE_SONG_BOT")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("TELE_SONG_BOT")
                await self.four.join_chat("TELE_SONG_BOT")
                await self.four.join_chat("TELE_SONG_BOT")
                await self.four.join_chat("TELE_SONG_BOT")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("TELE_SONG_BOT")
                await self.five.join_chat("TELE_SONG_BOT")
                await self.five.join_chat("TELE_SONG_BOT")
                await self.five.join_chat("TELE_SONG_BOT")
            except:
